...
public class TestCase11 extends BrowserManager {
    ...
    public void testSubscriptionInCartPage(){
        ...
        Assert.assertTrue(cartPage.verifyCartTextSubscription(),Utils.Constants
                .CART_SUBSCRIPTION_MESSAGE_IS_NOT_VISIBLE_SUCCESSFULLY);
        cartPage.clickCartSubscribe();
        Assert.assertTrue(cartPage.verifyCartSuccessfulSubscriptionText(),Utils.Constants
                .CART_SUCCESSFUL_SUBSCRIPTION_MESSAGE_IS_NOT_VISIBLE_SUCCESSFULLY);
